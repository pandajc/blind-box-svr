...
type UserTab struct {
	...
	Openid     string    `gorm:"uniqueIndex:uk_openid_state;column:openid;type:varchar(64);not null" json:"openid"`
	...
	State      int8      `gorm:"uniqueIndex:uk_openid_state;column:state;type:tinyint;not null;default:1;comment:'1-active 2-inactive'" json:"state"` // 1-active 2-inactive
